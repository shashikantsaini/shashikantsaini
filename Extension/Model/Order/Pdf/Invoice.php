<?php
namespace Bluethink\Extension\Model\Order\Pdf;
...
class Invoice extends \Magento\Sales\Model\Order\Pdf\Invoice
{
    ...
    protected function insertOrder(&$page, $obj, $putOrderId = true)
    {
        ...
        foreach ($order->getInvoiceCollection() as $invoice)
        {
            ...
            $shippingname = $invoice->getBillingAddress()->getName();
            $grandtotal = $invoice->getGrandTotal();
            $shippingemail = $invoice->getShippingAddress()->getEmail();
        }
        $codeContents="Invoice Id : #".$invoice_id."\nShipping Name : ".$shippingname."\nGrand Total : ".$grandtotal."\nEmail : ".$shippingemail;
        $fileSystem = $objectManager->create('\Magento\Framework\Filesystem');   
        $tempDir = $fileSystem->getDirectoryRead(\Magento\Framework\App\Filesystem\DirectoryList::MEDIA)->getAbsolutePath('tmp/qrcode/');
        ...
        /*width,height,*/
        $page->drawImage($image,220,$top-525,285,$top-465);
